...
var toDoListJustin = {
    ...
    couponAmounts = { milk: 0.75, spaghetti: 0.45, bread: 0.70, butter: 0.55,
...
var getGroceries = function (groceryAmount) {
	...
	console.log("We picked up " + groceryName + " and it is going to cost $" + transactionAmount);
};
...
var totalBeforeCoupons = function(){
	var amountBeforeCoupons = transactionAmounts[0]+ transactionAmounts[1] + transactionAmounts[2] +
...
var checkOut = function() {
	...
	totalAmountOfCoupons = (0.75 + 0.45 + 0.70 + 0.55 + 1.00 + 2.00),
...
var carFill = {
	...
	fullTankCost: function(){
		var totalCostOfGas = this.tankSizeInGallons * this.costPerGallon;
		var doneFillingTank = "The " + this.carName + " is filled with gas and it cost us $" + totalCostOfGas + ".";
